...
pub fn find_cursor_binary() -> Result<PathBuf> {
    // First check if `cursor` is in PATH
    ...
    anyhow::bail!(
        "Could not find Cursor CLI. Please ensure it's installed and in your PATH.\n\
